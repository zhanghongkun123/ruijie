 ...
 * @author lihengjing
 */
public class AuditApplyDetailDTO extends EqualsHashcodeSupport {
    ...
    private List<AuditFileDTO> auditFileList;

    private List<AuditApplyAuditLogDTO> auditorList;
    ...
    public List<AuditFileDTO> getAuditFileList() {
        return this.auditFileList;
    }

    public void setAuditFileList(List<AuditFileDTO> auditFileList) {
        this.auditFileList = auditFileList;
    }

    public List<AuditApplyAuditLogDTO> getAuditorList() {
        return this.auditorList;
    }

    public void setAuditorList(List<AuditApplyAuditLogDTO> auditorList) {

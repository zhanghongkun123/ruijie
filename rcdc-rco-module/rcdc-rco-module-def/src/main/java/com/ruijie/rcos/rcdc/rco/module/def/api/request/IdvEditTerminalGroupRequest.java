 ...
 * Create Time: 2019/11/26 18:37
 *
 * @author conghaifeng
 */
public class IdvEditTerminalGroupRequest extends CbbEditTerminalGroupDTO {
    ...
    @Nullable
    private Boolean isNeedApplyToSubgroup;
    ...
    public Boolean isNeedApplyToSubgroup() {
        return isNeedApplyToSubgroup;
    }

    public void setNeedApplyToSubgroup(Boolean needApplyToSubgroup) {
        isNeedApplyToSubgroup = needApplyToSubgroup;
    }

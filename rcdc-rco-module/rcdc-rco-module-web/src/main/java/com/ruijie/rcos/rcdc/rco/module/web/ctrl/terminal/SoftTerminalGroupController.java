...
@Controller
@RequestMapping("/rco/terminal/group/soft")
@EnableCustomValidate(enable = false)
public class SoftTerminalGroupController {

    private static final Logger LOGGER = LoggerFactory.getLogger(SoftTerminalGroupController.class);

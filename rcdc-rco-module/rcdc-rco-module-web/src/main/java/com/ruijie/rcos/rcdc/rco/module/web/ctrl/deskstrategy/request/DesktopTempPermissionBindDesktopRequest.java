 ...
 * @author linke
 */
public class DesktopTempPermissionBindDesktopRequest extends DeskPageSearchRequest {

    private static final String DESKTOP_TEMP_PERMISSION_ID = "desktopTempPermissionId";

    private UUID desktopTempPermissionId;

    public DesktopTempPermissionBindDesktopRequest(PageWebRequest webRequest) {
        super(webRequest);
    }

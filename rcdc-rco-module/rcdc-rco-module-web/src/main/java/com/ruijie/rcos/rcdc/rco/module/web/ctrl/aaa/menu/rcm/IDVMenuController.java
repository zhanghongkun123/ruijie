...
@BuiltInPermissions({
    ...
    @BuiltInPermission(parentCode = "systemMaintenance", code = "auditLogs", name = "审计日志",
            ...
            tags = {@PermissionTag(key = FunTypes.FUNTYPE, value = FunTypes.MENU),
                    ...
                    @PermissionTag(key = FunTypes.ENABLE_RCDC_NEED, value = FunTypes.YES), @PermissionTag(key = FunTypes.ORDER, value = "730")}),
...
// --------- END 监控平台 ---------
    ...
    @BuiltInPermission(parentCode = "systemMaintenance", code = "dataSecurityManage", name = "审批中心",
            tags = {@PermissionTag(key = FunTypes.FUNTYPE, value = FunTypes.MENU), @PermissionTag(key = FunTypes.ORDER, value = "900")}),

    @BuiltInPermission(parentCode = "dataSecurityManage", code = "auditFileManage", name = "文件导出审批",
            tags = {@PermissionTag(key = FunTypes.FUNTYPE, value = FunTypes.MENU), @PermissionTag(key = FunTypes.ORDER, value = "910")}),

    //外置存储管理
    @BuiltInPermission(parentCode = "systemMaintenance", code = "externalStorageManage", name = "文件服务器管理",
            tags = {@PermissionTag(key = FunTypes.FUNTYPE, value = FunTypes.MENU), @PermissionTag(key = FunTypes.FREE_DOM, value = FunTypes.YES),
...
public class IDVMenuController {
}

...
//                        @PermissionTag(key = FunTypes.ORDER, value = "6502")}),
        ...
        @BuiltInPermission(parentCode = "smsCertification", code = "testSmsCertification", name = "测试短信认证",
                ...
                tags = {
                        ...
                        @PermissionTag(key = FunTypes.ENABLE_SYS_ADMIN, value = FunTypes.YES),
                        @PermissionTag(key = FunTypes.ENABLE_INNER_ADMIN, value = FunTypes.YES),
                        @PermissionTag(key = FunTypes.ORDER, value = "6605")}),
        ...
        @BuiltInPermission(parentCode = "thirdPartyCertificationConfig", code = "testThirdPartyCertificationConfig", name = "测试连通性",
                ...
                tags = {
                        ...
                        @PermissionTag(key = FunTypes.ENABLE_SYS_ADMIN, value = FunTypes.YES),
                        @PermissionTag(key = FunTypes.ENABLE_INNER_ADMIN, value = FunTypes.YES),
                        @PermissionTag(key = FunTypes.ORDER, value = "6703")}),
        ...
        @BuiltInPermission(
                code = "getAuthConfig",
                name = "查看",
                parentCode = "authConfig",
                uri = "/iac/globalConfig/getAuthConfig",
                roles = {SECADMIN},
                tags = {
                        @PermissionTag(key = FunTypes.FUNTYPE, value = FunTypes.FUN),
        ...
        @BuiltInPermission(
                ...
                name = "编辑",
                parentCode = "authConfig",
                uri = "/iac/globalConfig/editAuthConfig",
                roles = {SECADMIN},
                tags = {
                        @PermissionTag(key = FunTypes.FUNTYPE, value = FunTypes.FUN),
                        @PermissionTag(key = FunTypes.ENABLE_INNER_ADMIN, value = FunTypes.YES),
        ...
        @BuiltInPermission(
                code = "pwdRecovertrategy",
                name = "密码找回策略",
                parentCode = "authSecurityManage",
                roles = {SECADMIN},
                tags = {
                        @PermissionTag(key = FunTypes.FUNTYPE, value = FunTypes.FUN),
                        @PermissionTag(key = FunTypes.ORDER, value = "7900"),
                        @PermissionTag(key = FunTypes.ENABLE_INNER_ADMIN, value = FunTypes.YES),
                        @PermissionTag(key = FunTypes.ENABLE_SEC_ADMIN, value = FunTypes.YES)
                }
        ),
        @BuiltInPermission(
                code = "detailPwdRecover",
                name = "查看",
                parentCode = "pwdRecovertrategy",
                uri = "/iac/smsCertification/pwdRecover/detail",
                roles = {SECADMIN},
                tags = {
                        @PermissionTag(key = FunTypes.FUNTYPE, value = FunTypes.FUN),
                        @PermissionTag(key = FunTypes.ORDER, value = "7901"),
                        @PermissionTag(key = FunTypes.ENABLE_INNER_ADMIN, value = FunTypes.YES),
                        @PermissionTag(key = FunTypes.ENABLE_SEC_ADMIN, value = FunTypes.YES),
                        @PermissionTag(key = FunTypes.ENABLE_LOOK, value = FunTypes.YES)
                }
        ...
        @BuiltInPermission(
                ...
                name = "编辑",
                parentCode = "pwdRecovertrategy",
                uri = "/iac/smsCertification/pwdRecover/edit",
                roles = {SECADMIN},
                tags = {
                        @PermissionTag(key = FunTypes.FUNTYPE, value = FunTypes.FUN),
                        @PermissionTag(key = FunTypes.ENABLE_INNER_ADMIN, value = FunTypes.YES),
                        @PermissionTag(key = FunTypes.ENABLE_SEC_ADMIN, value = FunTypes.YES),
                        @PermissionTag(key = FunTypes.ORDER, value = "7902")
                }
        ),
...
public class MiniGssMenuController {
}

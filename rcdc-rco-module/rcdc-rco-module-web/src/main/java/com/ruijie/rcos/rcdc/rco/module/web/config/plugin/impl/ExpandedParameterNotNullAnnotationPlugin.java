 ...
 */
@Controller
public class ExpandedParameterNotNullAnnotationPlugin extends AbstractExpandedParameterRequiredAnnotationPlugin
        implements ExpandedParameterBuilderPluginAPI<NotNull> {
     ...
     */
    @Override
    public void invoke(ParameterBuilder var0, NotNull var1) {

 ...
 * @author zwf
 */
public class ImportSpecialPathBatchTaskHandler extends AbstractBatchTaskHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(ImportSpecialPathBatchTaskHandler.class);
    ...
    public ImportSpecialPathBatchTaskHandler(ImportPathBatchTaskHandlerRequest request) {
    ...
    public BatchTaskItemResult processItem(BatchTaskItem batchTaskItem) throws BusinessException {
        ...
        try {
            LOGGER.info("执行用户配置导入，导入对象：{}", JSONObject.toJSONString(dto));
            //检查子路径个数是否超出
            ...
            LOGGER.error("导入特殊路径{}失败，失败原因：", dto.getName(), e);
    ...
    private void importPath(UUID groupId, UserProfilePathDTO dto, String userName) throws BusinessException {
        ...
        userProfileMgmtAPI.importSpecialUserProfilePath(dto);
    }
}

 ...
 */
@Controller
public class ExpandedParameterTextShortAnnotationPlugin implements ExpandedParameterBuilderPluginAPI<TextShort> {
     ...
     */
    @Override
    public void invoke(ParameterBuilder var0, TextShort var1) {
        Assert.notNull(var0, "var0 must not be null");
        Assert.notNull(var1, "var1 must not be null");
        var0.allowableValues(new AllowableRangeValues(String.valueOf(0), false, String.valueOf(TextShort.TEXT_SIZE), false));
        var0.required(true);
    }
}

 ...
 * @author nt
 */
public class CancelComponentIndependentUpgradeTerminalBatchTaskHandler extends AbstractBatchTaskHandler {
    ...
    public CancelComponentIndependentUpgradeTerminalBatchTaskHandler(CbbTerminalComponentIndependentUpgradeAPI cbbTerminalUpgradeAPI,
    ...
    private BatchTaskItemResult cancelUpgradeTerminalAddOptLog(String terminalId, UUID upgradeTaskId) throws BusinessException {
        ...
        try {
            ...
            auditLogAPI.recordLog(TerminalBusinessKey.RCDC_TERMINAL_COMPONENT_INDEPENDENT_UPGRADE_CANCEL_FAIL_LOG, terminalId.toUpperCase(),
                    e.getI18nMessage());
            throw new BusinessException(TerminalBusinessKey.RCDC_TERMINAL_COMPONENT_INDEPENDENT_UPGRADE_CANCEL_RESULT_FAIL, e, "",
                    e.getI18nMessage());
        }
        ...
        try {
            cbbTerminalUpgradeAPI.cancelIndependentUpgradeTerminal(cancelRequest);
            ...
            return DefaultBatchTaskItemResult.builder().batchTaskItemStatus(BatchTaskItemStatus.SUCCESS)
                    .msgKey(TerminalBusinessKey.RCDC_TERMINAL_COMPONENT_INDEPENDENT_UPGRADE_CANCEL_RESULT_SUCCESS)
                    .msgArgs(basicInfoDTO.getMacAddr().toUpperCase()).build();
        } catch (BusinessException e) {
    ...
    public BatchTaskFinishResult onFinish(int successCount, int failCount) {
        return buildDefaultFinishResult(successCount, failCount, TerminalBusinessKey.RCDC_TERMINAL_COMPONENT_INDEPENDENT_UPGRADE_CANCEL_RESULT);
    }
}

 ...
 * @author wjp
 */
public class UpdateVDIDeskStrategyWebRequest extends AbstractDeskStrategyWebRequest implements WebRequest {
    ...
    @ApiModelProperty(value = "剪切板", required = false)
    @Nullable

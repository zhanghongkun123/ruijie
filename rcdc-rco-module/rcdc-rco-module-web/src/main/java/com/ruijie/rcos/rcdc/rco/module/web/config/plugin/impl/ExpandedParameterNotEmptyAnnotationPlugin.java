 ...
 */
@Controller
public class ExpandedParameterNotEmptyAnnotationPlugin extends AbstractExpandedParameterRequiredAnnotationPlugin
        implements ExpandedParameterBuilderPluginAPI<NotEmpty> {
     ...
     */
    @Override
    public void invoke(ParameterBuilder var0, NotEmpty var1) {

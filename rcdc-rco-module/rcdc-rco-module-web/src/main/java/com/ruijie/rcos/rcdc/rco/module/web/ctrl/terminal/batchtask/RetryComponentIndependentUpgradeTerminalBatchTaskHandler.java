 ...
 * @author nt
 */
public class RetryComponentIndependentUpgradeTerminalBatchTaskHandler extends AbstractBatchTaskHandler {
    ...
    public RetryComponentIndependentUpgradeTerminalBatchTaskHandler(CbbTerminalComponentIndependentUpgradeAPI cbbTerminalUpgradeAPI,
    ...
    private BatchTaskItemResult retryUpgradeTerminalAddOptLog(String terminalId, UUID upgradeTaskId) throws BusinessException {
        ...
        try {
            ...
            auditLogAPI.recordLog(TerminalBusinessKey.RCDC_TERMINAL_COMPONENT_INDEPENDENT_UPGRADE_RETRY_FAIL_LOG, terminalId.toUpperCase(),
                    e.getI18nMessage());
            throw new BusinessException(TerminalBusinessKey.RCDC_TERMINAL_COMPONENT_INDEPENDENT_UPGRADE_RETRY_RESULT_FAIL, e, "", e.getI18nMessage());
        }
        ...
        try {
            cbbTerminalUpgradeAPI.retryIndependentUpgradeTerminal(retryRequest);
            ...
            return DefaultBatchTaskItemResult.builder().batchTaskItemStatus(BatchTaskItemStatus.SUCCESS)
                    .msgKey(TerminalBusinessKey.RCDC_TERMINAL_COMPONENT_INDEPENDENT_UPGRADE_RETRY_RESULT_SUCCESS)
            ...
            auditLogAPI.recordLog(TerminalBusinessKey.RCDC_TERMINAL_COMPONENT_INDEPENDENT_UPGRADE_RETRY_FAIL_LOG,
                    basicInfoDTO.getMacAddr().toUpperCase(),
                    e.getI18nMessage());
            throw new BusinessException(TerminalBusinessKey.RCDC_TERMINAL_COMPONENT_INDEPENDENT_UPGRADE_RETRY_RESULT_FAIL, e,
    ...
    public BatchTaskFinishResult onFinish(int successCount, int failCount) {
        return buildDefaultFinishResult(successCount, failCount, TerminalBusinessKey.RCDC_TERMINAL_COMPONENT_INDEPENDENT_UPGRADE_RETRY_RESULT);
    }
}

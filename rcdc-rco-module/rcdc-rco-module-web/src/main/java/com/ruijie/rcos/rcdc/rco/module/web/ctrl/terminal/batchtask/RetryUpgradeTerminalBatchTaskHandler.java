...
public class RetryUpgradeTerminalBatchTaskHandler extends AbstractBatchTaskHandler {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(RetryUpgradeTerminalBatchTaskHandler.class);
    ...
    public RetryUpgradeTerminalBatchTaskHandler(CbbTerminalSystemUpgradeAPI cbbTerminalUpgradeAPI,
                                                ...
                                                BaseAuditLogAPI auditLogAPI, CbbTerminalOperatorAPI cbbTerminalOperatorAPI) {
        super(iterator);
    ...
    private BatchTaskItemResult retryUpgradeTerminalAddOptLog(String terminalId, UUID upgradeTaskId)
        ...
        try {
            ...
            auditLogAPI.recordLog(TerminalBusinessKey.RCDC_RETRY_UPGRADE_TERMINAL_SUCCESS_LOG, terminalAddr);
            return DefaultBatchTaskItemResult.builder().batchTaskItemStatus(BatchTaskItemStatus.SUCCESS)
                    .msgKey(TerminalBusinessKey.RCDC_RETRY_UPGRADE_TERMINAL_RESULT_SUCCESS)
                    .msgArgs(new String[] {terminalAddr}).build();
        } catch (BusinessException e) {
            auditLogAPI.recordLog(TerminalBusinessKey.RCDC_RETRY_UPGRADE_TERMINAL_FAIL_LOG, terminalAddr,
                    e.getI18nMessage());
            throw new BusinessException(TerminalBusinessKey.RCDC_RETRY_UPGRADE_TERMINAL_RESULT_FAIL, e, terminalAddr, e.getI18nMessage());
        }
    }
    ...
    public BatchTaskFinishResult onFinish(int successCount, int failCount) {
        return buildDefaultFinishResult(successCount, failCount,
                TerminalBusinessKey.RCDC_RETRY_UPGRADE_TERMINAL_RESULT);
    }
}

...
public class RecoverRecycleBinBatchTaskHandlerTest {

    @Tested
    private RecoverRecycleBinBatchTaskHandler handler;
    ...
    public void testProcessItemWhenSuccess() throws Exception {
        ...
        assertEquals(UserBusinessKey.RCDC_RCO_RECYCLEBIN_RECOVER_ITEM_SUC_DESC, result.getMsgKey());
    }
    ...
    public void testProcessItemWhenException() throws Exception {
        ...
        assertEquals(UserBusinessKey.RCDC_RCO_RECYCLEBIN_RECOVER_ITEM_FAIL_DESC, result.getMsgKey());
    }

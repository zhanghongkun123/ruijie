...
public class ShutdownDesktopBatchTaskHandlerTest {

    @Tested
    private ShutdownDesktopBatchTaskHandler handler;
        ...
        new Verifications() {
            {
                ...
                cloudDesktopOperateAPI.shutdown(new CloudDesktopShutdownRequest(deskId, Boolean.FALSE));
                times = 1;
            }
        };
    }

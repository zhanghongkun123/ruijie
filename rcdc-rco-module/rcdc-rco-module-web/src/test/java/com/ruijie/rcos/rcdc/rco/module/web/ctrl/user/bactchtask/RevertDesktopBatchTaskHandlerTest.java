...
public class RevertDesktopBatchTaskHandlerTest {

    @Tested
    private RevertDesktopBatchTaskHandler handler;
        ...
        new Verifications() {
            {
                ...
                cbbIDVDeskOperateAPI.restoreDeskIDV(new CbbRestoreDeskRequest(deskId));
                times = 1;
            }
        };
    }
        ...
        new Verifications() {
            {
                ...
                cloudDesktopOperateAPI.restore((CbbRestoreDeskRequest) any);
                times = 1;
            }
        };
    }

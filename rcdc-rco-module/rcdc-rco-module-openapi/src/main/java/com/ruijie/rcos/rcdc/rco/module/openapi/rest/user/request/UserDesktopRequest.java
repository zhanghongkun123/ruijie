 ...
 * @author zqj
 */
public class UserDesktopRequest {
     ...
     */
    @Nullable
    private List<String> desktopCategoryList = new ArrayList<>();
    ...
    public void setDesktopCategoryList(@Nullable List<String> desktopCategoryList) {

 ...
 * @author TD
 */
public class UpdateDeskStrategyRequest {
     ...
     */
    @NotNull
    private Boolean enableDoubleScreen = Boolean.FALSE;
     ...
     */
    @NotNull
    private Boolean enableUsbReadOnly = Boolean.FALSE;
     ...
     */
    @NotNull
    private Boolean enableInternet = Boolean.TRUE;
    ...
    /**
     * 磁盘映射枚举，关闭、可读、读写，默认关闭
     */
    @NotNull
    private DiskMappingEnum diskMappingType = DiskMappingEnum.CLOSED;
     ...
     */
    @Nullable
    private CbbDeskStrategyUsage cbbDeskStrategyUsage = CbbDeskStrategyUsage.DESK;
    ...
    @Nullable
    public CbbDeskStrategyUsage getCbbDeskStrategyUsage() {
        return cbbDeskStrategyUsage;
    }

    public void setCbbDeskStrategyUsage(@Nullable CbbDeskStrategyUsage cbbDeskStrategyUsage) {
        this.cbbDeskStrategyUsage = cbbDeskStrategyUsage;
    }
}

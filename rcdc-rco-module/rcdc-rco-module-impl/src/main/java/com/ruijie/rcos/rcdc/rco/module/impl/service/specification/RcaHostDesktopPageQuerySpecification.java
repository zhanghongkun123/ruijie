 ...
 * @author chenl
 */
public class RcaHostDesktopPageQuerySpecification extends PageQuerySpecification<ViewRcaHostDesktopEntity> {
    ...
    public RcaHostDesktopPageQuerySpecification(String searchKeyword, List<String> searchColumnList, MatchEqual[] matchEqualArr, Boolean isAnd) {
        super(searchKeyword, searchColumnList, matchEqualArr, isAnd);
    }

    @Override
    public Predicate toPredicate(Root<ViewRcaHostDesktopEntity> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
    ...
    @Override
    protected Predicate buildLikePredicate(Root<ViewRcaHostDesktopEntity> root, CriteriaBuilder cb) {
    ...
    private void buildScheduleTaskDefaultExpressions(Root<ViewRcaHostDesktopEntity> root, CriteriaBuilder cb, Predicate rootPredicate) {
    ...
    private void buildDesktopTempPermissionSubQueryExpressions(Root<ViewRcaHostDesktopEntity> root, CriteriaQuery<?> query, CriteriaBuilder cb,

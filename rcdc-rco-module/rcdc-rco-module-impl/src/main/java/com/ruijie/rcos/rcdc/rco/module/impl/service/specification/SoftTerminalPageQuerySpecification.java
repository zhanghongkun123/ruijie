 ...
 * @author lyb
 */
public class SoftTerminalPageQuerySpecification extends PageQuerySpecification<ViewSoftTerminalEntity> {

    public SoftTerminalPageQuerySpecification(String searchKeyword, List<String> searchColumnList, MatchEqual[] matchEqualArr, Boolean isAnd) {
        super(searchKeyword, searchColumnList, matchEqualArr, isAnd);
    }

    @Override
    protected Predicate buildLikePredicate(Root<ViewSoftTerminalEntity> root, CriteriaBuilder cb) {

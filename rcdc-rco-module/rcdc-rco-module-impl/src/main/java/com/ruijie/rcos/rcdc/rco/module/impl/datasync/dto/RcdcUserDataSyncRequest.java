 ...
 * @author coderLee23
 */
public class RcdcUserDataSyncRequest implements Serializable {
    ...
    @NotNull
    private UserSyncDataDTO userSyncDataDTO;
    ...
    public UserSyncDataDTO getUserSyncDataDTO() {
        return userSyncDataDTO;
    }

    public void setUserSyncDataDTO(UserSyncDataDTO userSyncDataDTO) {
        this.userSyncDataDTO = userSyncDataDTO;
    }
}

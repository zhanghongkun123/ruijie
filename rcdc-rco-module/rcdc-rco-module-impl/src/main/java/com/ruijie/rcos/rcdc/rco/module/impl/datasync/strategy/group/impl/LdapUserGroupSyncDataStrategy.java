 ...
 */
@Service
public class LdapUserGroupSyncDataStrategy extends AbstractCommonUserGroupSyncDataStrategy {

    private static final Logger LOGGER = LoggerFactory.getLogger(LdapUserGroupSyncDataStrategy.class);

...
/**
 * Description: 云应用策略绑定用户视图
 * Copyright: Copyright (c) 2022
 * Company: Ruijie Co., Ltd.
 * Create Time: 2022/5/31 下午9:03
 *
 * @author yanlin
 */
@Entity
@Table(name = "v_rca_strategy_user")
public class ViewRcaStrategyUserEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    private UUID id;

    private UUID rcaStrategyId;

    private UUID dynamicUserRcaStrategyId;
    ...
    public UUID getRcaStrategyId() {
        return rcaStrategyId;
    }

    public void setRcaStrategyId(UUID rcaStrategyId) {
        this.rcaStrategyId = rcaStrategyId;
    }

    public UUID getDynamicUserRcaStrategyId() {
        return dynamicUserRcaStrategyId;
    }

    public void setDynamicUserRcaStrategyId(UUID dynamicUserRcaStrategyId) {
        this.dynamicUserRcaStrategyId = dynamicUserRcaStrategyId;
    }

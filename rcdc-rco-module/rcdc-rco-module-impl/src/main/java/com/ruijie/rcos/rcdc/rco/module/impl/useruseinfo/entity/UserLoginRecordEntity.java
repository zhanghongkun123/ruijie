 ...
 */
@Entity
@Table(name = "t_cbb_user_login_record")
public class UserLoginRecordEntity {
     ...
     * @return : 返回值
     **/
    public static UserLoginRecordDTO convertEntityToDTO(UserLoginRecordEntity entity) {
        ...
        dto.setTerminalMac(entity.getTerminalMac());

--- 3.1.54 START --
--delete from t_rco_software_group where id = '138bf952-880b-46cd-a0ea-71ea81501706';
INSERT INTO t_rco_software_group VALUES ('138bf952-880b-46cd-a0ea-71ea81501706', '未分组', 'CUSTOM', '默认分组', 0) ON CONFLICT (id) DO NOTHING;
--- 3.1.54 END --
--- 3.1.60 START --
...
values ('603184f4-9422-46ac-86a3-43dcdde60d8e', 'RG-CT7900', 'IDV', 'product', true, now(), now(),0, 'RG-CT7',null) ON CONFLICT (id) DO NOTHING;
--- 3.1.60 END --
--- 3.1.90 START--
--- 增加一键安装配置
INSERT INTO t_rco_global_parameter (id, param_key, param_value, default_value, create_time, update_time,version)
VALUES ('361a158d-a935-43da-9764-ff061c8f98e6','app_one_click_install', '{"openOneInstall":true,"serverIp":"","proxyServerIp":"","proxyPort":""}', '', now(), now(), 0) ON CONFLICT (id) DO NOTHING;
--- 3.1.90 END --
--- 3.1.93 START --
...
values
    ('93ab8ff8-1f6e-62f1-6e54-b153dcbaf798', 'RG-CT5300C', 'IDV,VOI', 'product', true, now(), now(), 0, 'RG-CT5', null) ON CONFLICT (id) DO NOTHING;
-- 支持RG-CT5502C-G3作为IDV/TCI使用
insert into t_rco_terminal_work_mode_mapping
    (id, support_mode, working_mode, judge_basis, enable_state, create_time, update_time, version, match_rule, sub_match_rule)
values
    ('566b9d3f-3251-7c60-ab0d-fd4d6d545d04', 'RG-CT5502C-G3', 'IDV,VOI', 'product', true, now(), now(), 0, 'RG-CT5', null) ON CONFLICT (id) DO NOTHING;
--- 3.1.93 END --
--- 3.1.130 START --
...
VALUES
( '13f60a6a-d7aa-40b9-bd6d-d8ec34d36a9c', 'send_syslog_schedule_type', 'DAY', 'DAY', now(), now(), 0 ) ON CONFLICT(param_key) DO NOTHING;
-- 定时发送syslog 间隔发送长度（分钟）
INSERT INTO
    t_rco_global_parameter("id", "param_key", "param_value", "default_value", "create_time", "update_time", "version")
VALUES
( '13f60a6a-d7aa-40b9-bd6d-d8ec34d36a9b', 'send_syslog_schedule_interval_minute', '1', '1', now(), now(), 0 ) ON CONFLICT(param_key) DO NOTHING;
...
-- 是否开启系统盘自动扩容
INSERT INTO t_rco_global_parameter ( "id", "param_key", "param_value", "default_value", "create_time", "update_time", "version" )
VALUES( 'f7903c7a-0307-3d20-04b2-729095ae6f02', 'enable_full_system_disk', 'false', 'false', now(), now(), 0 ) ON CONFLICT(param_key) DO NOTHING;
...
INSERT INTO "t_rco_global_parameter" ("id", "param_key", "param_value", "default_value", "create_time", "update_time", "version")
VALUES ('ed0dad6e-6f75-46ca-8d93-0dd1c055bd8b', 'ENABLE_SOFTWARE_STRATEGY', 'false', 'false', now(), now(), 0) ON CONFLICT(param_key) DO NOTHING;
...
INSERT INTO
    t_rco_global_parameter("id", "param_key", "param_value", "default_value", "create_time", "update_time", "version")
VALUES
( 'ae5f5ef7-0a68-4cc3-afc0-6d3beefd13f1', 'terminal_simplify_deployment_config', '{"enableTerminalSimplifyDeployment":false}', '{"enableTerminalSimplifyDeployment":false}', now(), now(), 0 ) ON CONFLICT(param_key) DO NOTHING;
--- 3.1.131 END --
--- 3.1.133 START --
-- 智慧教室 RG-OPS 终端模糊接入
insert into t_rco_terminal_work_mode_mapping (id, support_mode, working_mode, judge_basis, enable_state, create_time, update_time, version,match_rule,sub_match_rule)
values ('fdb1b781-30eb-4ae2-b006-e408b5f2e051', 'RG-OPS', 'IDV,VOI', 'product', true, now(), now(),0, 'RG-OPS',null) ON CONFLICT(id) DO NOTHING;;
--- 3.1.133 END --
--- 3.1.154 START --
INSERT INTO t_rco_user_profile_path_group VALUES ('476e2c79-73fa-4107-8587-400121894234', '常用配置', null, now(), now()) ON CONFLICT(id) DO NOTHING;
...
INSERT INTO t_rco_user_profile_path VALUES ('bcc50c59-3475-0bec-73ea-c967a43439a4', '476e2c79-73fa-4107-8587-400121894234', 'Windows文件夹',
 'windows系统自带的文件夹', 'SPECIAL', now(), '2022-05-31 09:56:11.207', 0, 'admin', 'f')  ON CONFLICT(id) DO NOTHING;
...
INSERT INTO t_rco_user_profile_path_detail VALUES ('56c097a2-fdf6-4dc6-88bb-3e9e4c06a03d', '%USERPROFILE%\Contacts', '034842b4-5927-c792-51ff-aa8b9a02f936',
 'bcc50c59-3475-0bec-73ea-c967a43439a4', 0, 0) ON CONFLICT(id) DO NOTHING;
...
'bcc50c59-3475-0bec-73ea-c967a43439a4', 1, 0) ON CONFLICT(id) DO NOTHING;
...
'bcc50c59-3475-0bec-73ea-c967a43439a4', 2, 0) ON CONFLICT(id) DO NOTHING;
...
'bcc50c59-3475-0bec-73ea-c967a43439a4', 3, 0) ON CONFLICT(id) DO NOTHING;
...
'bcc50c59-3475-0bec-73ea-c967a43439a4', 4, 0) ON CONFLICT(id) DO NOTHING;
...
'bcc50c59-3475-0bec-73ea-c967a43439a4', 5, 0) ON CONFLICT(id) DO NOTHING;
...
'bcc50c59-3475-0bec-73ea-c967a43439a4', 6, 0) ON CONFLICT(id) DO NOTHING;
...
'bcc50c59-3475-0bec-73ea-c967a43439a4', 7, 0) ON CONFLICT(id) DO NOTHING;
...
'bcc50c59-3475-0bec-73ea-c967a43439a4', 8, 0) ON CONFLICT(id) DO NOTHING;
...
INSERT INTO t_rco_user_profile_path VALUES ('99b5a12d-4875-01e7-0f13-40c3b7b54ae1', '476e2c79-73fa-4107-8587-400121894234', 'Windows便笺',
 '包括Windows便笺数据备份(win10)、Windows7便笺', 'SPECIAL', now(), '2022-05-31 09:56:12.207', 0, 'admin', 'f')  ON CONFLICT(id) DO NOTHING;
...
'78a70909-cde4-309c-cb1f-fa3e329157f4', '99b5a12d-4875-01e7-0f13-40c3b7b54ae1', 0, 0) ON CONFLICT(id) DO NOTHING;
...
'78a70909-cde4-309c-cb1f-fa3e329157f4', '99b5a12d-4875-01e7-0f13-40c3b7b54ae1', 1, 0) ON CONFLICT(id) DO NOTHING;
...
INSERT INTO t_rco_user_profile_path VALUES ('3f830bb2-7829-77ae-f991-6d09c7ee4b80', '476e2c79-73fa-4107-8587-400121894234', 'Windows桌面背景',
 'Windows桌面背景', 'SPECIAL', now(), '2022-05-31 09:56:14.207', 0, 'admin', 'f') ON CONFLICT(id) DO NOTHING;
...
'9b2d3cf1-81f2-2da9-e018-a14f3f2400b8', '3f830bb2-7829-77ae-f991-6d09c7ee4b80', 0, 0) ON CONFLICT(id) DO NOTHING;
...
INSERT INTO t_rco_user_profile_path VALUES ('296cb47e-82f6-b2b0-1d93-dda600a57648', '476e2c79-73fa-4107-8587-400121894234', 'Windows桌面图标',
 '个性化配置中选择桌面要显示哪些桌面图标（计算机、用户文档、控制面板等），不保存快捷方式图标信息', 'SPECIAL', now(), '2022-05-31 09:56:17.207', 0, 'admin', 'f') ON CONFLICT(id) DO NOTHING;
...
'0d4df0d9-699b-41f2-7347-c364ba213ff0', '296cb47e-82f6-b2b0-1d93-dda600a57648', 0, 0) ON CONFLICT(id) DO NOTHING;
...
INSERT INTO t_rco_user_profile_path VALUES ('40d6ea91-3440-486f-93a6-cb0ca2811824', '476e2c79-73fa-4107-8587-400121894234', 'Windows桌面图标排序',
 '记录桌面图标排序', 'SPECIAL', now(), '2022-05-31 09:56:17.217', 0, 'admin', 'f') ON CONFLICT(id) DO NOTHING;
...
'b8c2e685-1475-414b-b387-119330549d29', '40d6ea91-3440-486f-93a6-cb0ca2811824', 0, 0) ON CONFLICT(id) DO NOTHING;
...
INSERT INTO t_rco_user_profile_path VALUES ('2ff65afd-e2ad-1365-1eae-49e6853b11d3', '476e2c79-73fa-4107-8587-400121894234', 'Windows键盘与输入法',
 'Windows键盘布局、默认输入法设置、输入法列表顺序、用户安装输入法热键设置、系统自带输入法热键设置', 'SPECIAL', now(), '2022-05-31 09:56:18.207', 0, 'admin', 'f') ON CONFLICT(id) DO NOTHING;
...
'64d3081b-e685-dff1-11f2-9acda0dc0668', '2ff65afd-e2ad-1365-1eae-49e6853b11d3', 0, 0) ON CONFLICT(id) DO NOTHING;
...
'64d3081b-e685-dff1-11f2-9acda0dc0668', '2ff65afd-e2ad-1365-1eae-49e6853b11d3', 1, 0) ON CONFLICT(id) DO NOTHING;
...
'64d3081b-e685-dff1-11f2-9acda0dc0668', '2ff65afd-e2ad-1365-1eae-49e6853b11d3', 2, 0) ON CONFLICT(id) DO NOTHING;
...
'64d3081b-e685-dff1-11f2-9acda0dc0668', '2ff65afd-e2ad-1365-1eae-49e6853b11d3', 3, 0) ON CONFLICT(id) DO NOTHING;
...
'64d3081b-e685-dff1-11f2-9acda0dc0668', '2ff65afd-e2ad-1365-1eae-49e6853b11d3', 4, 0) ON CONFLICT(id) DO NOTHING;
...
INSERT INTO t_rco_user_profile_path VALUES ('d259fd29-89e3-6312-ca22-7f40a427ecca', '476e2c79-73fa-4107-8587-400121894234', 'Win7网络驱动器信息',
  '包括Win7网络驱动器的网络位置信息和要连接的文件夹列表', 'SPECIAL', now(), '2022-05-31 09:56:19.207', 0, 'admin', 'f') ON CONFLICT(id) DO NOTHING;
...
'27205d7c-e9d3-24fd-1991-7661304997a0', 'd259fd29-89e3-6312-ca22-7f40a427ecca', 0, 0) ON CONFLICT(id) DO NOTHING;
...
'27205d7c-e9d3-24fd-1991-7661304997a0', 'd259fd29-89e3-6312-ca22-7f40a427ecca', 1, 0) ON CONFLICT(id) DO NOTHING;
...
INSERT INTO t_rco_user_profile_path VALUES ('0680816e-3aa8-ca5c-c124-30727fe74a5c', '476e2c79-73fa-4107-8587-400121894234', '文件夹重定向配置',
  '记录文件夹的文件存储位置', 'SPECIAL', now(), '2022-05-31 09:56:20.207', 0, 'admin', 'f') ON CONFLICT(id) DO NOTHING;
...
INSERT INTO t_rco_user_profile_path_detail VALUES ('56c097a2-fdf6-4dc6-88bb-1e9e5c06a03d','HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Explorer\Shell Folders',
 '4745b697-f8ee-6d85-7ebc-a02fea415b72', '0680816e-3aa8-ca5c-c124-30727fe74a5c', 0, 0) ON CONFLICT(id) DO NOTHING;
INSERT INTO t_rco_user_profile_path_detail VALUES ('56c097a2-fdf6-4dc6-88bb-1e9e5c06a02d','HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Explorer\User Shell Folders',
 '4745b697-f8ee-6d85-7ebc-a02fea415b72', '0680816e-3aa8-ca5c-c124-30727fe74a5c', 1, 0) ON CONFLICT(id) DO NOTHING;
...
INSERT INTO t_rco_user_profile_path VALUES ('8b782e0a-0f1c-4fc8-80d0-8d4bf1d4533c', '476e2c79-73fa-4107-8587-400121894234', 'IE浏览器Internet选项',
  'IE浏览器Internet选项', 'SPECIAL', now(), '2022-05-31 09:56:21.208', 0, 'admin', 'f') ON CONFLICT(id) DO NOTHING;
...
INSERT INTO t_rco_user_profile_path_detail VALUES ('ac59dd07-688a-4b77-b390-4f82de74403c', 'HKEY_CURRENT_USER\Software\Microsoft\Internet Explorer',
 'b7ee3b69-f314-4e7e-9d05-efd3666e641a','8b782e0a-0f1c-4fc8-80d0-8d4bf1d4533c', 0, 0) ON CONFLICT(id) DO NOTHING;
...
'b7ee3b69-f314-4e7e-9d05-efd3666e641a', '8b782e0a-0f1c-4fc8-80d0-8d4bf1d4533c', 1, 0) ON CONFLICT(id) DO NOTHING;
...
INSERT INTO t_rco_user_profile_path VALUES ('b0ad67fc-1a23-461f-a93b-8c941d0516ec', '476e2c79-73fa-4107-8587-400121894234', '搜狗五笔输入法',
  '支持五笔拼音的属性设置', 'SPECIAL', now(), '2022-05-31 09:56:21.209', 0, 'admin', 'f') ON CONFLICT(id) DO NOTHING;
...
INSERT INTO t_rco_user_profile_path_detail VALUES ('99917447-23b2-43eb-916b-6315a6db2f89', '%USERPROFILE%\AppData\LocalLow\SogouWB',
 'f5a93253-da5f-4bd1-9ac6-be938f232562','b0ad67fc-1a23-461f-a93b-8c941d0516ec', 0, 0) ON CONFLICT(id) DO NOTHING;
...
'f5a93253-da5f-4bd1-9ac6-be938f232562', 'b0ad67fc-1a23-461f-a93b-8c941d0516ec', 1, 0) ON CONFLICT(id) DO NOTHING;
...
INSERT INTO t_rco_user_profile_path VALUES ('b8ac36c9-5885-4672-99c5-5bfed925cc49', '476e2c79-73fa-4107-8587-400121894234', '搜狗拼音输入法',
  '支持搜狗拼音的属性设置', 'SPECIAL', now(), '2022-05-31 09:56:21.211', 0, 'admin', 'f') ON CONFLICT(id) DO NOTHING;
...
INSERT INTO t_rco_user_profile_path_detail VALUES ('36344ec2-58f7-4122-80f9-9ca35c855d99', '%USERPROFILE%\AppData\LocalLow\SogouPY.users',
 'f48ba90f-4f75-4465-afda-41e761d7b2dc','b8ac36c9-5885-4672-99c5-5bfed925cc49', 0, 0) ON CONFLICT(id) DO NOTHING;
...
'f48ba90f-4f75-4465-afda-41e761d7b2dc', 'b8ac36c9-5885-4672-99c5-5bfed925cc49', 1, 0) ON CONFLICT(id) DO NOTHING;
...
INSERT INTO t_rco_user_profile_path VALUES ('a49e481c-aefa-4d80-bcd3-25d4d5bdf121', '476e2c79-73fa-4107-8587-400121894234', 'QQ五笔输入法',
 '支持QQ五笔的属性设置', 'SPECIAL', now(), '2022-05-31 09:56:16.214', 0, 'admin', 'f') ON CONFLICT(id) DO NOTHING;
...
'3d571743-0d36-45e8-bc1b-db6e9686b731', 'a49e481c-aefa-4d80-bcd3-25d4d5bdf121', 0, 0) ON CONFLICT(id) DO NOTHING;
...
INSERT INTO t_rco_user_profile_path VALUES ('67a16917-9bc6-4a6e-90e1-b5ebbef1e9ba', '476e2c79-73fa-4107-8587-400121894234', 'QQ拼音输入法',
 '支持QQ五笔的属性设置', 'SPECIAL', now(), '2022-05-31 09:56:16.217', 0, 'admin', 'f') ON CONFLICT(id) DO NOTHING;
...
'5a20176d-522d-4e07-bc8f-b2dadd8079ec', '67a16917-9bc6-4a6e-90e1-b5ebbef1e9ba', 0, 0) ON CONFLICT(id) DO NOTHING;
...
INSERT INTO t_rco_user_profile_path VALUES ('a8dcab34-6e50-4891-a205-a2b7dfdd6e57', '476e2c79-73fa-4107-8587-400121894234', '360极速浏览器',
 '支持收藏夹和历史记录', 'SPECIAL', now(), '2022-05-31 09:56:16.227', 0, 'admin', 'f') ON CONFLICT(id) DO NOTHING;
...
'534be09c-f210-4e23-83f3-957d86178e69', 'a8dcab34-6e50-4891-a205-a2b7dfdd6e57', 0, 0) ON CONFLICT(id) DO NOTHING;
...
INSERT INTO t_rco_user_profile_path VALUES ('35ee3899-e291-402e-b5fe-73351fce27fa', '476e2c79-73fa-4107-8587-400121894234', '360安全浏览器',
 '支持收藏夹和历史记录', 'SPECIAL', now(), '2022-05-31 09:56:16.229', 0, 'admin', 'f') ON CONFLICT(id) DO NOTHING;
...
'3e9886bc-e5c0-426c-bb15-b13a582f64ed', '35ee3899-e291-402e-b5fe-73351fce27fa', 0, 0) ON CONFLICT(id) DO NOTHING;
...
INSERT INTO t_rco_user_profile_path VALUES ('dca6c4c9-c5a3-4d37-83b8-bd9f790ee9f7', '476e2c79-73fa-4107-8587-400121894234', '谷歌浏览器',
 '支持收藏夹和历史记录', 'SPECIAL', now(), '2022-05-31 09:56:16.237', 0, 'admin', 'f') ON CONFLICT(id) DO NOTHING;
...
'eff63d5d-eed2-4d12-a0b0-ff064beac6bd', 'dca6c4c9-c5a3-4d37-83b8-bd9f790ee9f7', 0, 0) ON CONFLICT(id) DO NOTHING;
...
INSERT INTO t_rco_user_profile_path VALUES ('d15e8ef8-2615-4aee-838a-998993b8db07', '476e2c79-73fa-4107-8587-400121894234', '用户配置文件',
  '与登录账户相关的桌面设置', 'SPECIAL', now(), '2022-05-31 09:56:21.241', 0, 'admin', 'f') ON CONFLICT(id) DO NOTHING;
...
INSERT INTO t_rco_user_profile_path_detail VALUES ('2092fdf2-ddb2-4f7e-8c3d-1b4c885cc06b', '%USERPROFILE%',
 '9abc7c8b-e4d4-4c83-9647-7b66eced9116','d15e8ef8-2615-4aee-838a-998993b8db07', 0, 0) ON CONFLICT(id) DO NOTHING;
...
INSERT INTO t_rco_user_profile_path VALUES ('5e711bc7-21e6-c6ca-126e-d2d770959c27', '476e2c79-73fa-4107-8587-400121894234', 'AD域统一配置(加域桌面必选)',
  'Windows桌面加域场景统一配置，可保存域用户信息，避免每次重新初始化，加快登录过程', 'SPECIAL', now(), '2022-05-31 09:56:21.251', 0, 'admin', 'f') ON CONFLICT(id) DO NOTHING;
...
INSERT INTO t_rco_user_profile_path_detail VALUES ('5b80a4d9-6e40-1bac-d591-a52295d1120d', '%USERPROFILE%',
 '0b8998a5-8b41-96fe-8f62-eab765b37fbf','5e711bc7-21e6-c6ca-126e-d2d770959c27', 0, 0) ON CONFLICT(id) DO NOTHING;
...
-- 'e2a99832-a7a1-ae4c-0a8a-a87f8d73fadf','5e711bc7-21e6-c6ca-126e-d2d770959c27', 0, 0) ON CONFLICT(id) DO NOTHING;
...
2, 0) ON CONFLICT(id) DO NOTHING;
INSERT INTO t_rco_user_profile_path_detail VALUES ('37d8c817-0cca-b972-6f1e-14b05c7ebc18', '%TEMP%',
 '8f567761-0006-70ce-9c5c-3a88ce129c96','5e711bc7-21e6-c6ca-126e-d2d770959c27', 0, 0) ON CONFLICT(id) DO NOTHING;
--INSERT INTO t_rco_user_profile_path_detail VALUES ('709b9106-d5ad-4df2-98fe-c708d37d5dbe', '%LOCALAPPDATA%\Packages',
-- '8f567761-0006-70ce-9c5c-3a88ce129c96','5e711bc7-21e6-c6ca-126e-d2d770959c27', 1, 0) ON CONFLICT(id) DO NOTHING;
...
INSERT INTO t_rco_user_profile_path VALUES ('1245de2f-9485-01e5-c411-2ca817eecb7a', '476e2c79-73fa-4107-8587-400121894234', 'Windows凭据',
 '用户为网站、已连接的应用程序和网络保存的登录信息', 'SPECIAL', now(), '2022-05-31 09:56:22.207', 0, 'admin', 'f') ON CONFLICT(id) DO NOTHING;
...
'1245de2f-9485-01e5-c411-2ca817eecb7a', 0, 0) ON CONFLICT(id) DO NOTHING;
--- 3.1.154 END --
--- 3.1.155 START --
...
--  RG-CT5702C-G3终端支持
insert into t_rco_terminal_work_mode_mapping (id, support_mode, working_mode, judge_basis, enable_state, create_time, update_time, version,match_rule,sub_match_rule)
values ('5eb249ad-e297-4be8-bbd6-fb1b8c17b082', 'RG-CT5702C-G3', 'IDV,VOI,VDI', 'product', true, now(), now(),0, 'RG-CT5',null) ON CONFLICT(id) DO NOTHING;
--- 3.1.165 END --
--- 3.1.166 START --
--DELETE FROM t_rco_user_profile_path_detail WHERE id='a21a0194-d6a1-1cdb-42a3-9a8bb15100c2';
--DELETE FROM t_rco_user_profile_child_path WHERE id='e2a99832-a7a1-ae4c-0a8a-a87f8d73fadf';
--- 3.1.166 END --
